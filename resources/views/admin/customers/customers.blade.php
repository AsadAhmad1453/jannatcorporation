                            ...
                            <tbody>
                                @foreach ($customers as $customer)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('car-detail',$customer->car->id)}}" class="text-primary edit-company"  ><i data-feather='eye'></i></a>
                                            <a href="{{route('admin.delete.customer',$customer->id)}}" class="text-danger confirm-remove-country"><i data-feather='trash'></i></a>
                                        </td>
                                   </tr>
                                @endforeach
                            </tbody>
